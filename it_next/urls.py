...
# This has been added to support the allauth library
    ...
    path ('checkout/', auth_view.LoginView.as_view(template_name = 'web/checkout.html'), name = 'checkout'),
    path ('billing/', userview.Billing, name = 'billing'),
    path ('login/', auth_view.LoginView.as_view(template_name = 'users/login.html'), name = 'login'),
    path ('logout/', auth_view.LogoutView.as_view(template_name = 'users/logout.html'), name = 'logout'),
    path("logout/", auth_view.LogoutView.as_view(), name=""),  
